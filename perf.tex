...
\subtitle{}
\date{March 30. 2023, BSCS2011}%{\today}
...
\pause
Because all (single thread) computation ``behaves'' like this. (Unless there are hardware bugs\footnote<2->{\url{https://en.wikipedia.org/wiki/Spectre_(security_vulnerability)}})
\end{frame}
...
Why is not something you should concern yourself with?
